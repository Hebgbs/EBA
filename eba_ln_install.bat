...
ECHO.
ECHO Current game directory is %des_ln%.
ECHO Note: If this is incorrect, terminate this batch script and edit line
ECHO       12 so %%des_ln%% reflects the cars directory you wish to affect.
ECHO.
